;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="5d85051d984ac4afecdf7228eaceffc6";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["dL9bqtp4sDp2"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["dL9bqtp4sDp2"].options={"blocks":[{"code":"\u003c!-- Matomo --\u003e\n\u003cscript type=\"text/javascript\"\u003e\n  var _paq = window._paq = window._paq || [];\n  /* tracker methods like \"setCustomDimension\" should be called before \"trackPageView\" */\n  _paq.push(['trackPageView']);\n  _paq.push(['enableLinkTracking']);\n  (function() {\n    var u=\"https://glitchcity.wiki/matomo/\";\n    _paq.push(['setTrackerUrl', u+'matomo.php']);\n    _paq.push(['setSiteId', '1']);\n    var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];\n    g.type='text/javascript'; g.async=true; g.src=u+'matomo.js'; s.parentNode.insertBefore(g,s);\n  })();\n\u003c/script\u003e\n\u003c!-- End Matomo Code --\u003e","location":{"method":"append","selector":"head"}}]};;CloudflareApps.installs["dL9bqtp4sDp2"].selectors={"blocks[0].location.selector":"head"};;if(CloudflareApps.matchPage(CloudflareApps.installs['dL9bqtp4sDp2'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['dL9bqtp4sDp2'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['dL9bqtp4sDp2'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}